...
const Footer: React.FC = () => {
  ...
  const footerLinks = {
    services: [
      { name: 'Private Jet Charter', href: '/services' },
      { name: 'Air Ambulance', href: '/services' },
      { name: 'Aircraft Management', href: '/services' },
      { name: 'Global Network', href: '/services' },
    ],
    company: [
      { name: 'About Us', href: '/' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Elevating your travel experience with premium private jet charter services. 
                Global destinations, personalized attention, and unmatched luxury.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">contact@crystalwings.com</span>
                </div>
                <div className="flex items-center space-x-3">
          ...
          <div className="border-t border-gray-700 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <p className="text-gray-400 text-sm">
                © {currentYear} Crystal Wings. All rights reserved.
              </p>
            </div>
          </div>
        </div>
